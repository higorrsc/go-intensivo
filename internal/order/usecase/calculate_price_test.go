...
import (
	...
	"github.com/higorrsc/go-intensivo/internal/order/entity"
	"github.com/higorrsc/go-intensivo/internal/order/infra/database"
...
type CalculatePriceUseCaseTestSuite struct{
	suite.Suite
	OrderRepository database.OrderRepository//ntity.OrderRepositoryInterface
	Db *sql.DB
}
